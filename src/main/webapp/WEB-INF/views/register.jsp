...
<body>
	<div class="container-fluid">
		...
		<div class="col-md-2" align="center">
			<figure>
				<img alt="Logo" src="resources/images/logo.png" height="100px"
					width="100px">
			</figure>
		</div>
		<div class="col-md-5"></div>
	...
	<div id="blank"></div>
	<form:form action="doRegister" modelAttribute="register" method="post"
				...
				<div id="logindiv">
					...
					<div id="box" class="col-md-8" align="left">
						<input type="text" name="username" class="form-control"
							placeholder="Enter Username" required="required" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{1,20}$"/>
					</div>
				</div>
				<div id="logindiv">
	...
	%>
	<div align="center">
		<h1 id="title">You are Already Registered!!</h1>
	</div>
